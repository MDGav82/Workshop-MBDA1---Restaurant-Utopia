...
// Jour.jsx
// Tailwind + JSX component that recreates a clean "Menu du Jour" layout.
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Poisson du jour, légumes croquants", price: "13€" },
      ],
    },
    {
      id: "desserts",
...
export default function Jour({ data = menuData }) {
  return (
      ...
      <article className="w-full max-w-3xl bg-white shadow-lg rounded-2xl overflow-hidden">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          {data.sections.map((section) => (
            <section key={section.id} className="space-y-3">
              <h2 className="text-xl font-semibold text-gray-700 border-l-4 border-brown pl-3">
                {section.title}
              </h2>
        ...
        <footer className="p-6 border-t bg-gray-50 flex items-center justify-between">
          <p className="text-xs text-gray-500">
            Plat du jour servi jusqu'à épuisement des stocks.
          </p>
          <p className="text-xs text-gray-500">
