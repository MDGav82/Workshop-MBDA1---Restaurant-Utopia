...
// Branch.jsx
// Tailwind + JSX component that recreates a clean "Menu du Branch" layout.
// Replace the `menuData` contents with the exact text from your PDF.

const menuData = {
  title: "MENU DU Brunch",
  date: "30/09/2025",
  sections: [
    {
      id: "entrees",
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Poisson du Branch, légumes croquants", price: "13€" },
      ],
    },
    {
      id: "desserts",
...
export default function Branch({ data = menuData }) {
  return (
      ...
      <article className="w-full max-w-3xl bg-white shadow-lg rounded-2xl overflow-hidden">
        ...
        <footer className="p-6 border-t bg-gray-50 flex items-center justify-between">
          <p className="text-xs text-gray-500">
            Plat du Branch servi jusqu'à épuisement des stocks.
          </p>
          <p className="text-xs text-gray-500">
